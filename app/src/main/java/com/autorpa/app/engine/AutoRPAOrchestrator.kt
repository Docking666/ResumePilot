package com.autorpa.app.engine
...
class AutoRPAOrchestrator(
    ...
    private val preferences: com.autorpa.app.data.PreferencesManager
) {
...
class ScriptEngine(
    ...
    suspend fun execute(): RPAAccessibilityService.ExecutionResult? {

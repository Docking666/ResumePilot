        ...
        return try {
            ...
            when (actionStr) {
                ...
                "CLICK" -> {
                    ...
                    LLMDecision.Action(com.autorpa.app.engine.Action.Click(
                        x = params.getInt("x"),
                        y = params.getInt("y"),
                ...
                "TYPE" -> {
                    val params = json.getJSONObject("params")
                    LLMDecision.Action(com.autorpa.app.engine.Action.Type(
                ...
                "SWIPE" -> {
                    val params = json.getJSONObject("params")
                    LLMDecision.Action(com.autorpa.app.engine.Action.Swipe(
                ...
                "BACK" -> LLMDecision.Action(com.autorpa.app.engine.Action.Back)
                "HOME" -> LLMDecision.Action(com.autorpa.app.engine.Action.Home)
                "WAIT" -> {
                    val params = json.getJSONObject("params")
                    LLMDecision.Action(com.autorpa.app.engine.Action.Wait(
                ...
                "SCROLL" -> {
                    ...
                    val dir = if (params.getString("direction").uppercase() == "UP")
                        ...
                        com.autorpa.app.engine.Action.ScrollDirection.DOWN
                    LLMDecision.Action(com.autorpa.app.engine.Action.Scroll(dir))
                }
                "FIND_CLICK" -> {
                    val params = json.getJSONObject("params")
                    LLMDecision.Action(com.autorpa.app.engine.Action.FindAndClick(
